let url = 'https://albertchongus.github.io/mydata/top10_1999.json'
...
let drawRects = () => {
    ...
    svg.selectAll('rect')
        ...
        .on('mouseover', (item) => {
            ...
            tooltip.text('Year 1989: No.1 China 33,390')
        })
        .on('mouseout', (item) => {
            tooltip.transition()
...
let genAnnotation = () => {
    ...
    const annotations = [
        {
          note: { label: "No.1: China Number: 54,466"  },
          color: ["#EF5B0C"],
          x: 80,
          y: 90,
          dy: -1,
