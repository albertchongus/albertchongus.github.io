let url = 'https://albertchongus.github.io/mydata/top10_1969.json'
...
let drawRects = () => {
    ...
    svg.selectAll('rect')
        ...
        .on('mouseover', (item) => {
            ...
            tooltip.text('Year 1959: No.1 Canada 5,679')
        })
        .on('mouseout', (item) => {
            tooltip.transition()
...
let genAnnotation = () => {
    ...
    const annotations = [
        {
          note: { label: "No.1: Canada Number: 13,318"  },
          color: ["#EF5B0C"],
          x: 80,
          y: 130,
          dy: -1,
