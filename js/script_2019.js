let url = 'https://albertchongus.github.io/mydata/top10_2019.json'
...
let drawRects = () => {
    ...
    svg.selectAll('rect')
        ...
        .on('mouseover', (item) => {
            ...
            tooltip.text('Year 2009: No.1 China 127,628')
        })
        .on('mouseout', (item) => {
            tooltip.transition()
...
let genAnnotation = () => {
    ...
    const annotations = [
        {
          note: { label: "No.1: China Number: 372,532"  },
          color: ["#EF5B0C"],
          x: 80,
          y: 80,
          dy: -1,
